      ...
      <div className="max-w-4xl mx-auto" ref={ref}>
        ...
        >
          ...
          <div className="space-y-5">
            <h3 className="font-syne font-bold text-[14px] text-white mb-6">Contact Details</h3>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-3">
            <h3 className="font-syne font-bold text-[14px] text-white mb-2">Send a Message</h3>
            <input
              type="text"
            ...
            <button
              type="submit"
              className="w-full font-syne font-semibold text-sm bg-[#00d4aa] text-[#0a0f1e] py-3 rounded-lg hover:bg-[#00a88a] transition-all active:scale-[0.98]"
            >
